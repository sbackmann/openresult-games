...
from .cognition import (
    StagHuntDummyActComponent,
    StagHuntActComponent,
)
...
class StagHuntDummyPersona(MoralityDummyPersona):
    ...
    def __init__(
        ...
        self.act = StagHuntDummyActComponent(model, cfg, actions, max_num_rounds)
        self.act.init_persona_ref(self)


class StagHuntPersona(MoralityPersona):
    last_collected_resource_num: int
    other_personas: dict[str, "StagHuntPersona"]

    act: StagHuntActComponent
    ...
    def __init__(
        ...
        act_cls: type[StagHuntActComponent] = StagHuntActComponent,
    ) -> None:
        if scenario == "sh_base":
