...
class ChickenPerturbationEnv(MoralityPerturbationEnv):
    def __init__(
    ...
    def _prompt_round_payoffs(self, agent: str) -> str:
        ...
        if "ch_base" in self.cfg.name.lower():
    ...
    def _generate_inputs_low(self) -> None:
        ...
        return self._generate_inputs_stochastic()
